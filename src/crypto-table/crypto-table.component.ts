...
export class CryptoTableComponent {
  ...
  // listens to cryptoservice for top100 cryptos data
  // filteredCryptos is being rendered
  ...
  // sorts an array numerically ascending/descending depending on provided boolean
  ...
  // sorts an array alphabetically ascending/descending depending on provided boolean
